...
class KorFinanceNewsSummarization(AbsTaskSummarization):
    metadata = TaskMetadata(
        name="KorFinanceNewsSummarization",
        description="주어진 경제 뉴스에 대한 요약문이 맞는지 0 (False), 1 (True) 로 분류합니다.",
        reference="",
        dataset={
            "path": "nmixx-fin/twice_kr_news_summ",
            "revision": "main",
        },
        type="Summarization",
        category="p2p",
