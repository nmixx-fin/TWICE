...
class KorLawSummarization(AbsTaskSummarization):
    metadata = TaskMetadata(
        name="KorLawSummarization",
        description="주어진 법률에 대한 요약문이 맞는지 0 (False), 1 (True) 로 분류합니다.",
        reference="",
        dataset={
            "path": "nmixx-fin/twice_kr_law_summ",
            "revision": "main",
        },
        type="Summarization",
        category="p2p",
