...
class KorFinanceColumnSummarization(AbsTaskSummarization):
    metadata = TaskMetadata(
        name="KorFinanceColumnSummarization",
        description="주어진 경제 칼럼에 대한 요약문이 맞는지 0 (False), 1 (True) 로 분류합니다.",
        reference="https://aihub.or.kr/aihubdata/data/view.do?currMenu=115&topMenu=100&aihubDataSe=realm&dataSetSn=97",
        dataset={
